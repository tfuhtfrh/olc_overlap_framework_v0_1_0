"""QBSolv test for the pure-selection weighted edge-order QUBO."""
from __future__ import annotations
import json,time
from pathlib import Path
from dwave_qbsolv import QBSolv,ENERGY_IMPACT
from experimental_chm13_pure_selection_order_qubo import (
    build_model,encode_order,audit,PureSelectionOrderConfig,DATASET_DIR
)

OUT=Path("debug/qubo/chm13_pure_selection_qbsolv_20260925.json")
SIZES=[47,100,200]
SEED=20260925

def main():
    m,reward,cfg=build_model(PureSelectionOrderConfig())
